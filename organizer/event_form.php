...
?>
<section class="plain-page-head"><div class="container plain-page-head-inner"><div><span class="plain-page-label">Organizer workspace</span><h1><?= e($title) ?></h1><p>Complete the event details below. Required fields are marked.</p></div></div></section>
