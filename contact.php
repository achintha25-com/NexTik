    ...
    <div class="container detail-grid contact-layout">
        <div class="form-card">
            ...
            <form method="post" action="<?= e(app_url('contact')) ?>">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="name" name="name" value="<?= e($_POST['name'] ?? '') ?>"
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="message" name="message" maxlength="2000"
        ...
        <aside class="detail-card contact-info-card">
            ...
            <div class="contact-note">
                ...
                <p>For a faster response, include your booking reference, the event name, and the email address used for
                    the reservation.</p>
            </div>
        </aside>
    </div>
...
<section class="section contact-map-section">
    <div class="container contact-map-card">
        <div class="contact-map-copy">
            ...
            <a class="text-link" href="https://www.google.com/maps/search/?api=1&query=Colombo+03%2C+Sri+Lanka"
                target="_blank" rel="noopener">Open in Google Maps <span>&rarr;</span></a>
        </div>
        <div class="contact-map-frame">
            <iframe src="https://www.google.com/maps?q=Colombo%2003%2C%20Sri%20Lanka&output=embed"
                title="NexTik location in Colombo 03" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
            </iframe>
        </div>
    </div>
</section>
