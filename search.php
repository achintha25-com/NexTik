...
if ($search !== '') {
    $conditions[] = '(e.title LIKE ? OR e.description LIKE ? OR e.venue LIKE ? OR e.city LIKE ? OR c.name LIKE ? OR c.slug LIKE ?)';
    $term = '%' . $search . '%';
    array_push($parameters, $term, $term, $term, $term, $term, $term);
}
