    ...
    <div class="container">
        ...
        <div class="about-feature-grid">
            <article class="about-feature-card">
                ...
                <p>Browse upcoming events by category, city, date, and search term, then see the details that matter
                    before booking.</p>
            </article>
            <article class="about-feature-card">
                <span class="about-feature-number">02</span>
                <h3>Reserve without confusion</h3>
                <p>Choose your tickets, review the total, and receive a clear booking reference that is easy to keep and
                    find later.</p>
            </article>
            <article class="about-feature-card">
                <span class="about-feature-number">03</span>
                <h3>Manage events smoothly</h3>
                <p>Organizers can publish events and monitor reservations while administrators keep the catalogue
                    accurate and dependable.</p>
            </article>
        </div>
    </div>
</section>
        ...
        <ol class="about-steps">
            <li>
                ...
                <div>
                    ...
                    <p>Search the catalogue and open a complete event overview.</p>
                </div>
            </li>
            <li>
                <span>02</span>
                <div>
                    ...
                    <p>Check the date, venue, price, and available ticket quantity.</p>
                </div>
            </li>
            <li>
                <span>03</span>
                <div>
                    ...
                    <p>Access your booking reference and reservation history from your account.</p>
                </div>
            </li>
        </ol>
    </div>
