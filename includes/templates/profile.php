                ...
                <form method="post" action="<?= e(app_url('profile')) ?>">
                    ...
                    <div class="profile-form-grid">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="name" name="name" value="<?= e($profile['name']) ?>"
                                maxlength="255" required>
                        </div>
                        <div class="form-group">
                            <label for="email">Email address</label>
                            <input class="form-control" id="email" name="email" type="email"
                                value="<?= e($profile['email']) ?>" maxlength="255" required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="password-field">
                            ...
                            <button type="button" class="password-toggle"
                                data-password-toggle="current_password">Show</button>
                        </div>
                    </div>
                    <div class="profile-form-grid">
                        <div class="form-group">
                            ...
                            <div class="password-field">
                                ...
                                <button type="button" class="password-toggle"
                                    data-password-toggle="new_password">Show</button>
                            </div>
                        </div>
                        <div class="form-group">
