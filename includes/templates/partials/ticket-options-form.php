...
<div class="ticket-options-block">
    <div class="ticket-options-heading">
        <div>
            ...
            <p class="form-hint">Add choices like VIP, Standing, or General Admission. Each option has its own price and ticket count.</p>
        </div>
        ...
        <?php foreach ($options as $option): ?>
            <div class="ticket-option-row">
                ...
                <div class="form-group">
                    <label>Name</label>
                    <input class="form-control" name="option_name[]" value="<?= e($option['name'] ?? '') ?>" maxlength="100" placeholder="VIP" required>
                </div>
                <div class="form-group">
                    <label>Price (LKR)</label>
                    <input class="form-control" name="option_price[]" type="number" min="0" step="0.01" value="<?= e($option['price'] ?? '') ?>" required>
                </div>
                <div class="form-group">
