...
<head>
    ...
    <link rel="stylesheet"
        href="<?= e(asset_url('css/style.css')) ?>?v=<?= (int) filemtime(dirname(__DIR__) . '/css/style.css') ?>">
    <link rel="stylesheet"
        href="<?= e(asset_url('css/theme.css')) ?>?v=<?= (int) filemtime(dirname(__DIR__) . '/css/theme.css') ?>">
</head>
<?php
    ...
    <header class="site-header">
        <div class="container header-inner">
            ...
            <span class="header-country" aria-label="Sri Lanka">
                <img class="header-flag" src="<?= e(asset_url('images/ui/sri-lanka-flag.svg')) ?>"
                    alt="Sri Lankan flag">
            </span>
            <button class="menu-toggle" type="button" aria-label="Toggle menu"
                data-menu-toggle><span></span><span></span><span></span></button>
