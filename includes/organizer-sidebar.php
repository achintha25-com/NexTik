...
<aside class="admin-sidebar organizer-sidebar">
    ...
    <div class="admin-sidebar-account"><span><?= e(strtoupper(substr($user['name'] ?? 'O',0,1))) ?></span><div><strong><?= e($user['name'] ?? 'Organizer') ?></strong><small>Event organizer</small></div></div>
</aside>
